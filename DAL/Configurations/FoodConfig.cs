...
namespace DAL.Configurations
{
    public class FoodConfig : IEntityTypeConfiguration<Food>
    {
        ...
        public void Configure(EntityTypeBuilder<Food> builder)
        {
            ...
            //builder.HasData(
            //    new Food { Id = 1, Name = "Antrikot", Calorie = 1.21, Image = ReadFile("Resources/antrikot.png") , CreatedDate=DateTime.Now.Date,UpdatedDate=DateTime.Now.Date,State=true },
            //    new Food { Id = 2, Name = "Biftek", Calorie = 2.42, Image = ReadFile("Resources/biftek.png") , CreatedDate = DateTime.Now.Date, UpdatedDate = DateTime.Now.Date, State = true },
            //    new Food { Id = 3, Name = "Bonfile", Calorie = 1.38, Image = ReadFile("Resources/bonfile.png") }
                ...
                //    new Food { Id = 87, Name = "Bulgur Pilavı", Calorie = 2.15, Image = ReadFile("Resources/bulgur pilavı.png") },
                ...
                //    new Food { Id = 98, Name = "Hünkar Beğendi", Calorie = 1.74, Image = ReadFile("Resources/hunkar begendi.jpg") },
